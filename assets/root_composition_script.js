 ...
 * {
 *   "subcompName": {
 *     "__APPLY_CHECKBOX_KEY": "Control Node Name", // name of checkbox to use to determine whether this subcomp should be applied
            ...
            for (const [key, value] of Object.entries(data.payload)) {
              ...
              if (subComp) {
                ...
                if (Object.hasOwnProperty(value, APPLY_CHECKBOX_KEY)) {
                  if (Object.hasOwnProperty(currentPayload, value[APPLY_CHECKBOX_KEY])) {
                    shouldUpdate = currentPayload[value[APPLY_CHECKBOX_KEY]];
                  } else {
                    console.error("the given toggle control node", value[APPLY_CHECKBOX_KEY], "was not found in", subComp)
                  }
                }
                ...
                console.error("couldn't find", subComp, "in the composition (it was provided by the data stream)")
              }
            }
          }
        }
